...
- transparent: everyone can see what a record is made of, and if you
  change this later, client code may break (unlike a private field in a class)
...
class RecordDemo {
    void main() {
        ...
        IO.println(c.center()); // Point[x=0, y=0]
        IO.println(c.area());
    }
}